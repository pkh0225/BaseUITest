...
public final class DropDown: UIView {
	...
	*/
	...
	fileprivate var _xConstraint: NSLayoutConstraint!
	fileprivate var _yConstraint: NSLayoutConstraint!
...
extension DropDown {
	...
	public override func updateConstraints() {
        ...
        _xConstraint.constant = layout.x
        _yConstraint.constant = layout.y
        _widthConstraint.constant = layout.width
        _heightConstraint.constant = layout.visibleHeight
	...
	fileprivate func setupConstraints() {
        ...
        _xConstraint = NSLayoutConstraint(
			...
			multiplier: 1,
			constant: 0)
		addConstraint(_xConstraint)

        _yConstraint = NSLayoutConstraint(
			item: tableViewContainer,
			attribute: .top,
			relatedBy: .equal,
			toItem: self,
			...
			multiplier: 1,
			constant: 0)
		addConstraint(_yConstraint)

        _widthConstraint = NSLayoutConstraint(
			item: tableViewContainer,
			attribute: .width,
			relatedBy: .equal,
			toItem: nil,
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(_widthConstraint)
        ...
        _heightConstraint = NSLayoutConstraint(
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(_heightConstraint)
