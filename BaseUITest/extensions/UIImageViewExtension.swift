...
extension UIImageView {
    ...
    public func setStrechImage(_ inset: UIEdgeInsets?) {
        guard let nomalImage = self.image else { return }
        ...
        let resizeImage: UIImage = nomalImage.resizableImage(withCapInsets: edgeInset, resizingMode: .stretch)
        self.image = resizeImage

        if let highlightedImage = self.highlightedImage {
            let highlightedResizeImage = highlightedImage.resizableImage(withCapInsets: edgeInset, resizingMode: .stretch)
