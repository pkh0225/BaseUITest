...
//            print("label: \(label), value: \(value)")
            ...
            case let value as [Any]:
                var addArray = [Any]()
                for item in value {
                    if let subArray: [JSONRepresentable] = item as? [JSONRepresentable] {
                        var addSubArray: [[String: Any]] = [[String: Any]]()
                        for subItem: JSONRepresentable in subArray {
                    ...
                    else if let item: JSONRepresentable = item as? JSONRepresentable {
